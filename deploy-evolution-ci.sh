...
docker exec fluxbus-db-ci psql -U fluxbus_ci -c "CREATE DATABASE evolution_ci;" 2>/dev/null || echo "   ⚠️  Banco já existe"
echo "   ✅ Banco pronto!"
echo ""
...
echo "   - QR Code: https://evolution.z7botsolutions.com.br/instance/connect/fluxbus"
echo "   - API Key: B6D711FCDE4D4FD5936544120E713976"
echo ""
echo "📋 Próximos passos:"
echo "   1. Criar instância: POST /instance/create"
echo "   2. Obter QR Code: GET /instance/connect/fluxbus"
...
echo "   curl -H 'apikey: B6D711FCDE4D4FD5936544120E713976' https://evolution.z7botsolutions.com.br/instance/connect/fluxbus"
echo ""
