...
DECLARE
    ...
    v_vehicle_3_id UUID;
    v_work_post_id UUID;
    v_os_1_id UUID := gen_random_uuid();
    v_os_2_id UUID := gen_random_uuid();
    v_os_3_id UUID := gen_random_uuid();
    v_os_4_id UUID := gen_random_uuid();
    v_os_5_id UUID := gen_random_uuid();
BEGIN
    ...
    IF v_company_id IS NULL THEN
        ...
        INSERT INTO companies (id, name, trade_name, cnpj, sigla, status)
        VALUES (v_company_id, 'EMPRESA MATRIZ TRANSPORTE E SERVICOS', 'Matriz Frota', '11.222.333/0001-99', 'MTZ', 'ACTIVE');
    END IF;
    ...
    IF v_client_id IS NULL THEN
        ...
        INSERT INTO clients (id, name, trade_name, cnpj, email, phone, status, company_id, created_at, updated_at)
        VALUES (v_client_id, 'MINERAÇÃO & LOGÍSTICA VALE DO SOL S/A', 'Vale do Sol', '22.333.444/0001-55', 'contato@valedosol.com.br', '(31) 3456-7890', 'ACTIVE', v_company_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
    END IF;
    ...
    IF v_work_post_id IS NULL THEN
        ...
        INSERT INTO work_posts (id, post_code, name, address, type, status, client_id, required_vigilantes, work_schedule, shift_start, shift_end)
        VALUES (v_work_post_id, 'OBRA-CENTRAL-01', 'Obra Mineração Mina Norte', 'Rodovia BR-040 Km 520, Contagem - MG', '24H', 'ATIVO', v_client_id, 4, '12x36', '06:00', '18:00');
    END IF;

    -- 5. Obter ou criar Fornecedores (Suppliers)
    SELECT id INTO v_supplier_id FROM suppliers WHERE company_id = v_company_id OR company_id IS NULL LIMIT 1;
    IF v_supplier_id IS NULL THEN
        v_supplier_id := gen_random_uuid();
        INSERT INTO suppliers (id, name, trade_name, cnpj, email, phone, status, company_id, created_at, updated_at)
        VALUES (v_supplier_id, 'AUTO PEÇAS E COMPONENTES DIESEL LTDA', 'Diesel Peças', '33.444.555/0001-66', 'vendas@dieselpecas.com.br', '(31) 3399-1122', 'ACTIVE', v_company_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
    END IF;

    v_supplier_auto_id := gen_random_uuid();
    INSERT INTO suppliers (id, name, trade_name, cnpj, email, phone, status, company_id, created_at, updated_at)
    VALUES (v_supplier_auto_id, 'AUTO CENTER & OFICINA MECÂNICA ESPECIALIZADA LTDA', 'Oficina Central Diesel', '44.555.666/0001-77', 'oficina@centraldiesel.com.br', '(31) 3388-2233', 'ACTIVE', v_company_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
    ON CONFLICT DO NOTHING;

    v_supplier_comb_id := gen_random_uuid();
    INSERT INTO suppliers (id, name, trade_name, cnpj, email, phone, status, company_id, created_at, updated_at)
    VALUES (v_supplier_comb_id, 'POSTO E DISTRIBUIDORA DE COMBUSTÍVEIS IPIRANGA S/A', 'Posto Ipiranga Rodoanel', '55.666.777/0001-88', 'combustivel@postoipiranga.com.br', '(31) 3377-3344', 'ACTIVE', v_company_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
    ON CONFLICT DO NOTHING;
    ...
    IF v_vehicle_1_id IS NULL THEN
        ...
        INSERT INTO vehicles (id, plate, brand, model, year, fuel_type, current_mileage, status, vehicle_type, company_id, work_post_id, client_id, created_at, updated_at)
        VALUES (v_vehicle_1_id, 'FLX-1A23', 'VOLKSWAGEN', '17.230 OD Ônibus Urbano', 2023, 'DIESEL', 85400, 'ATIVO', 'BUS', v_company_id, v_work_post_id, v_client_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
    END IF;
    ...
    IF v_vehicle_2_id IS NULL THEN
        ...
        INSERT INTO vehicles (id, plate, brand, model, year, fuel_type, current_mileage, status, vehicle_type, company_id, work_post_id, client_id, created_at, updated_at)
        VALUES (v_vehicle_2_id, 'FLX-2B45', 'MERCEDES-BENZ', 'OF-1721 Bluetec 5 Fretamento', 2022, 'DIESEL', 142300, 'ATIVO', 'BUS', v_company_id, v_work_post_id, v_client_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
    END IF;
    ...
    IF v_vehicle_3_id IS NULL THEN
        ...
        INSERT INTO vehicles (id, plate, brand, model, year, fuel_type, current_mileage, status, vehicle_type, company_id, work_post_id, client_id, created_at, updated_at)
        VALUES (v_vehicle_3_id, 'FLX-3C67', 'MARCOPOLO / VOLVO', 'B270F Rodoviário Executivo', 2024, 'DIESEL', 32100, 'ATIVO', 'BUS', v_company_id, v_work_post_id, v_client_id, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
    END IF;
    ...
    INSERT INTO invoices (
        ...
        6420.00, 'FIXO', 'PAGO', CURRENT_DATE - INTERVAL '10 days', CURRENT_DATE - INTERVAL '30 days', CURRENT_DATE - INTERVAL '10 days',
    ...
    INSERT INTO invoices (
        ...
        3200.00, 'VARIAVEL', 'ATRASADO', CURRENT_DATE - INTERVAL '4 days', CURRENT_DATE - INTERVAL '20 days',
    ...
    INSERT INTO invoices (
        ...
        8950.00, 'FIXO', 'PENDENTE', CURRENT_DATE + INTERVAL '20 days', CURRENT_DATE - INTERVAL '10 days',
    ...
    INSERT INTO accounts_receivable (
        ...
        26800.00, 26800.00,
        CURRENT_DATE - INTERVAL '35 days', CURRENT_DATE - INTERVAL '5 days', CURRENT_DATE - INTERVAL '6 days', 'RECEIVED', 'FREIGHT', 'TRANSFER',
    ...
    INSERT INTO accounts_receivable (
        ...
        32000.00, 16000.00,
        CURRENT_DATE - INTERVAL '12 days', CURRENT_DATE + INTERVAL '18 days', CURRENT_DATE - INTERVAL '2 days', 'PARTIAL', 'FREIGHT', 'PIX',
    ...
    INSERT INTO accounts_receivable (
        ...
        54100.00, 0.00,
        CURRENT_DATE - INTERVAL '2 days', CURRENT_DATE + INTERVAL '25 days', 'PENDING', 'CONTRACT', 'BOLETO',
