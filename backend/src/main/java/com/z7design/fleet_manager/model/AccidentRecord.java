...
public class AccidentRecord {
    ...
    @NotNull(message = "Data do acidente Ã© obrigatÃ³ria")
    ...
    @NotBlank(message = "Local do acidente Ã© obrigatÃ³rio")
    @Column(nullable = false)
    private String location;

    @NotNull(message = "Tipo de acidente Ã© obrigatÃ³rio")
    @Enumerated(EnumType.STRING)
    @Column(name = "accident_type", nullable = false)
    private AccidentType accidentType;

    @NotBlank(message = "DescriÃ§Ã£o do acidente Ã© obrigatÃ³ria")
    ...
    private String catNumber; // NÃºmero da CAT (ComunicaÃ§Ã£o de Acidente de Trabalho)
