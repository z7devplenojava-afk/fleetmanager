...
import com.z7design.fleet_manager.model.enums.MeasurementType;
import lombok.Data;
...
public class MeasurementBulletinDTO {
    ...
    public static MeasurementBulletinDTO fromEntity(MeasurementBulletin entity) {
        ...
        // Note: calculationMemory nÃ£o Ã© uma relaÃ§Ã£o direta na entidade
        // MeasurementBulletin
        // SerÃ¡ tratado separadamente no serviÃ§o
