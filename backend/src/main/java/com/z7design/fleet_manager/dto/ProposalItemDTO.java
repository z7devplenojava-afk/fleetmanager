...
public class ProposalItemDTO {
    ...
    private java.util.UUID proposalId;
    ...
    // Constructors
    public ProposalItemDTO() {}
    
    public ProposalItemDTO(String description, Integer quantity, BigDecimal unitPrice) {
    ...
    public java.util.UUID getProposalId() {
        return proposalId;
    }
    
    public void setProposalId(java.util.UUID proposalId) {
