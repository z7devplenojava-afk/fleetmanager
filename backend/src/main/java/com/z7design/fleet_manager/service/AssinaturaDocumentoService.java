...
import com.z7design.fleet_manager.repository.AssinaturaDocumentoRepository;
...
public class AssinaturaDocumentoService {
    ...
    /**
     * Cria uma nova assinatura eletrÃ´nica
     */
    public AssinaturaDocumento criarAssinaturaEletronica(UUID documentoId, User usuario, 
        ...
        // Verificar se jÃ¡ foi assinado por este usuÃ¡rio
        if (assinaturaDocumentoRepository.existsByDocumentoGeradoAndUsuario(documento, usuario)) {
            throw new RuntimeException("Documento jÃ¡ foi assinado por este usuÃ¡rio");
        }
        ...
        // Atualizar status do documento se necessÃ¡rio
    ...
    /**
     * Cria uma assinatura digital (futura implementaÃ§Ã£o)
     */
    ...
    /**
     * Lista assinaturas de um usuÃ¡rio em um perÃ­odo
     */
    @Transactional(readOnly = true)
    ...
    /**
     * ObtÃ©m IP address da requisiÃ§Ã£o
     */
    ...
    private void atualizarStatusDocumento(DocumentoGerado documento) {
        // Se o documento ainda estÃ¡ pendente e foi assinado, marcar como assinado
