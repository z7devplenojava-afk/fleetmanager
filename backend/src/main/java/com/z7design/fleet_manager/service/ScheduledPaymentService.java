...
public class ScheduledPaymentService {
    ...
    /**
     * Buscar todos os pagamentos agendados com pagina̤̣o
     */
    @Transactional(readOnly = true)
    public Page<ScheduledPaymentDTO> getAllScheduledPayments(Pageable pageable) {
        log.info("Buscando todos os pagamentos agendados com pagina̤̣o");
    ...
    /**
     * Buscar todos os pagamentos agendados sem pagina̤̣o
     */
    @Transactional(readOnly = true)
    ...
    public ScheduledPaymentDTO getScheduledPaymentById(UUID id) {
        ...
        ScheduledPayment payment = scheduledPaymentRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Pagamento agendado ṇo encontrado com ID: " + id));
    ...
    public ScheduledPaymentDTO createScheduledPayment(ScheduledPaymentDTO dto) {
        ...
        Client client = clientRepository.findById(dto.getClientId())
                .orElseThrow(() -> new RuntimeException("Cliente ṇo encontrado com ID: " + dto.getClientId()));
    ...
    public void deleteScheduledPayment(UUID id) {
        ...
        if (!scheduledPaymentRepository.existsById(id)) {
            throw new RuntimeException("Pagamento agendado ṇo encontrado com ID: " + id);
        }
