...
public interface ModeloDocumentoRepository extends JpaRepository<ModeloDocumento, UUID> {
    ...
    /**
     * Busca modelos ativos ordenados por data de criaÃ§Ã£o
     */
    ...
    /**
     * Busca modelos criados por um usuÃ¡rio especÃ­fico
     */
    List<ModeloDocumento> findByCriadoPorIdAndAtivoTrue(UUID criadoPorId);
    
    /**
     * Busca modelos que contÃªm um placeholder especÃ­fico
     */
    ...
    /**
     * Busca modelos que nÃ£o foram utilizados recentemente
     */
    ...
    /**
     * Busca modelos criados em um perÃ­odo especÃ­fico
     */
