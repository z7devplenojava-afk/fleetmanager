...
import com.z7design.fleet_manager.dto.ScheduledPaymentDTO;
import com.z7design.fleet_manager.model.enums.ScheduledPaymentStatus;
import com.z7design.fleet_manager.service.ScheduledPaymentService;
...
@Slf4j
@Tag(name = "Pagamentos Agendados", description = "Endpoints para gestÃ£o de pagamentos agendados")
public class ScheduledPaymentController {
    ...
    @GetMapping("/all")
    @Operation(summary = "Listar todos os pagamentos agendados (sem paginaÃ§Ã£o)", description = "Retorna uma lista completa de todos os pagamentos agendados")
    public ResponseEntity<List<ScheduledPaymentDTO>> getAllWithoutPagination() {
        log.info("GET /api/scheduled-payments/all - Buscando todos os pagamentos agendados sem paginaÃ§Ã£o");
        return ResponseEntity.ok(scheduledPaymentService.getAllScheduledPayments());
    }
    
    @GetMapping("/{id}")
    @Operation(summary = "Buscar pagamento agendado por ID", description = "Retorna um pagamento agendado especÃ­fico pelo seu ID")
    @ApiResponses(value = {
    ...
    @GetMapping("/overdue")
    @Operation(summary = "Buscar pagamentos vencidos", description = "Retorna todos os pagamentos agendados que estÃ£o vencidos")
    ...
    @Operation(summary = "Gerar relatÃ³rio PDF de pagamentos agendados", description = "Gera relatÃ³rio PDF com filtros dinÃ¢micos")
    public ResponseEntity<byte[]> generateReportPDF(
        ...
        log.info("GET /api/scheduled-payments/reports/pdf - Gerando relatÃ³rio PDF com filtros");
    ...
    @Operation(summary = "Excluir mÃºltiplos pagamentos agendados", description = "Exclui vÃ¡rios pagamentos agendados selecionados")
