...
public class VisitControlController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<VisitControlDTO> getVisitControlById(@PathVariable("id") UUID id) {
    ...
    public ResponseEntity<List<VisitControlDTO>> getVisitsByStatus(@PathVariable("status") VisitControlStatus status) {
        List<VisitControlDTO> visits = visitControlService.getVisitsByStatus(status);
        return ResponseEntity.ok(visits);
    }

    @GetMapping("/supervisor/{supervisorId}")
    public ResponseEntity<List<VisitControlDTO>> getVisitsBySupervisor(@PathVariable("supervisorId") UUID supervisorId) {
    ...
    @PutMapping("/{id}/start")
    public ResponseEntity<VisitControlDTO> startVisit(@PathVariable("id") UUID id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteVisitControl(@PathVariable("id") UUID id) {
    ...
    public ResponseEntity<Map<String, Object>> findEmployeeByCpfOrRegistration(
            ...
            @RequestParam(value = "workPostId") UUID workPostId) {
        try {
