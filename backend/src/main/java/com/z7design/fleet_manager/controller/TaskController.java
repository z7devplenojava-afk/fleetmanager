...
import com.z7design.fleet_manager.dto.TaskDTO;
import com.z7design.fleet_manager.model.Task;
import com.z7design.fleet_manager.service.TaskService;
...
public class TaskController {
    ...
    public ResponseEntity<TaskDTO> update(@PathVariable String id, @Valid @RequestBody TaskDTO dto) {
        ...
        Task t = fromDTO(dto);
        t.setId(UUID.fromString(id)); // Certifique-se que o campo id do modelo Task ̩ UUID
        Task saved = taskService.save(t);
