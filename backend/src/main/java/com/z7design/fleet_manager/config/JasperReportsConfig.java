...
public class JasperReportsConfig {
    ...
    public byte[] generatePdfReport(String jrxmlPath, List<?> data, Map<String, Object> parameters) 
        ...
        configuration.setMetadataTitle("RelatÃ³rio Gerado pelo Sistema");
        configuration.setMetadataSubject("RelatÃ³rio de GestÃ£o");
        configuration.setMetadataCreator("Secure Guard");
        configuration.setMetadataKeywords("relatÃ³rio, gestÃ£o, vigilÃ¢ncia");
    ...
    /**
     * Cria parÃ¢metros padrÃ£o para relatÃ³rios
     */
    public Map<String, Object> createDefaultParameters() {
        Map<String, Object> parameters = new HashMap<>();
        parameters.put("REPORT_TITLE", "RelatÃ³rio do Sistema Secure Guard");
