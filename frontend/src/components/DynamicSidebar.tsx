...
const ROLE_ALLOWED_ITEM_IDS: Partial<Record<UserRole, Set<string>>> = {
  ...
  ENCARREGADO_DE_MANUTENCAO: new Set([
    'dashboard',
    'manutencao',
    'frota',
    'garagens',
  ...
  const getMenuGroups = () => {
    ...
    const groups = {
      ...
      frota: filteredItems.filter(item =>
        ['frota', 'garagens', 'manutencao', 'manutencao-v2', 'frota-os', 'abastecimento', 'pneus', 'gestao-portaria', 'gestao-checklist-cliente', 'gestao-limpeza', 'lavajato'].includes(item.id)
      ),
