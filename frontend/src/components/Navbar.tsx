          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              <a href="/" className="flex items-center">
                <img src="/promover-logo.png" alt="Fleet Manager" className="h-16 w-auto" />
              </a>
            </div>
            ...
            <nav className="hidden md:flex space-x-6">
              ...
              <a href="/servicos-publico" className="text-gray-300 hover:text-white transition-colors font-medium">Serviços</a>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-700">
              <nav className="flex flex-col space-y-3">
                ...
                <a href="/servicos-publico" className="text-gray-300 hover:text-white transition-colors font-medium px-2 py-2">Serviços</a>
