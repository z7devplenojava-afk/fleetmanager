...
import { Download, Printer, X, ZoomIn, ZoomOut, RotateCw, FileText } from 'lucide-react';

interface PurchaseRequestReportViewModalProps {
  isOpen: boolean;
  onClose: () => void;
  pdfBlob: Blob | null;
  fileName: string;
...
export function PurchaseRequestReportViewModal({
  isOpen,
  onClose,
  pdfBlob,
  fileName,
}: PurchaseRequestReportViewModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden bg-seguranca-graphite border-gray-600 p-0">
        ...
        <div className="flex flex-col h-[calc(90vh-80px)]">
          ...
          <div className="flex items-center justify-between p-4 bg-seguranca-black border-b border-gray-600">
            <div className="flex items-center gap-2">
              ...
              <span className="text-seguranca-lightgray text-sm font-medium min-w-[60px] text-center">
                {Math.round(zoom * 100)}%
              </span>
              <Button
                variant="outline"
              ...
              <Button
                ...
                className="border-gray-600 text-seguranca-lightgray hover:bg-seguranca-graphite ml-2"
              >
